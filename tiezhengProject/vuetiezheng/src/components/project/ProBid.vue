<template>
  <div>
           ...
           <el-table-column
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button @click="showEditBidView(scope.row)" style="padding: 3px 4px 3px 4px;margin: 2px"
                           size="mini">编辑
                </el-button>
                ...
                <el-button type="danger" style="padding: 3px 4px 3px 4px;margin: 2px" size="mini"
                           @click="deleteBid(scope.row)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
          <div style="display: flex;justify-content: space-between;margin: 2px">
            <el-button type="danger" size="mini" v-if="bids.length>0" :disabled="multipleSelection.length==0"
                       @click="deleteManyBids">批量删除
            </el-button>
            <el-pagination
              background
              :page-size="10"
    ...
    <el-form :model="bid" ref="addBidForm" style="margin: 0px;padding: 0px;">
      <div style="text-align: left">
        <el-dialog
            ...
            <el-col :span="10">
              <div>
                <el-form-item label="项目名称:" prop="projectName">
                  <el-input prefix-icon="el-icon-edit" v-model="bid.projectName" size="mini" style="width: 150px"
            ...
            <el-col :span="10">
              <div>
                <el-form-item label="标段名称:" prop="bidName">
                  <el-input prefix-icon="el-icon-edit" v-model="bid.bidName" size="mini" style="width: 150px"
          ...
          <el-row>
             <el-col :span="10">
              <div>
                <el-form-item label="标段地址:" prop="address">
                  <el-input prefix-icon="el-icon-edit" v-model="bid.address" size="mini" style="width: 150px"
                            placeholder="标段地址"></el-input>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <div>
                <el-form-item label="标段里程:" prop="km">
                  <el-input prefix-icon="el-icon-edit" v-model="bid.km" size="mini" style="width: 150px"
                            placeholder="标段里程"></el-input>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
             ...
             <el-col :span="10">
              <div>
                <el-form-item label="描述:" prop="description">
                  <el-input prefix-icon="el-icon-edit" v-model="bid.description" size="mini" style="width: 150px"
    ...
    <el-button size="mini" type="primary" @click="addBid('addBidForm')">确 定</el-button>
  </span>
        </el-dialog>
      </div>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      doDelete(ids){
        ...
        var _this = this;
        this.deleteRequest("/bid/deleteBid/" + ids).then(resp=> {
      ...
      loadBids(){
        var _this = this;
        this.tableLoading = true;
        this.getRequest("/bid/getBidsByPage?page=" + this.currentPage + "&size=10" ).then(resp=> {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            if (this.bid.id) {
              //更新
              this.tableLoading = true;
              this.putRequest("/bid/updateBid", this.bid).then(resp=> {
                _this.tableLoading = false;
                if (resp && resp.status == 200) {
                  var data = resp.data;
              ...
              //添加
              this.tableLoading = true;
              this.postRequest("/bid/addBid", this.bid).then(resp=> {
                _this.tableLoading = false;
                if (resp && resp.status == 200) {
                  var data = resp.data;
                  _this.dialogVisible = false;
      ...
      showEditBidView(row){
        ...
        this.bid = row;
        this.bid.projectName = row.projectName;
        this.bid.bidName = row.bidName;
        this.bid.address = row.address;
        this.bid.km = row.km;
        this.bid.description = row.description;
