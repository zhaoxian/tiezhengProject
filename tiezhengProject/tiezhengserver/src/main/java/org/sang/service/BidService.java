...
public class BidService {
    ...
    public List<Bid> getBidsByPage(Integer page, Integer size){
        int start = (page - 1) * size;
        return bidMapper.getBidsPage(start, size);
    }
    ...
    public boolean deleteBidById(String ids) {
        String[] split = ids.split(",");
        return bidMapper.deleteBidById(split) == split.length;
    }

    public List<Bid> getAllBids() {
        return bidMapper.getAllBids();
    }
