...
//    DecimalFormat decimalFormat = new DecimalFormat("##.00");
    ...
    public List<Section> getSectionByPage(Integer page, Integer size){
        int start = (page - 1) * size;
        return sectionMapper.getSectionByPage(start, size);
    }
    ...
    public boolean deleteSectionById(String ids) {
        String[] split = ids.split(",");
        return sectionMapper.deleteSectionById(split) == split.length;
    }
